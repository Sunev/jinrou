...
exports.new_rules=[
    ...
    # 护卫职业
    {
        ...
        label:
            ...
            visible:(rule)->
                return true if isAllJobsMode rule
                for job in ["Guard","Trapper","WanderingGuard","Cosplayer","Paladin"]
                    if rule.jobNumbers[job]>0
                        return true
                return false
        items:[
