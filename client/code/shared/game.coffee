...
exports.new_rules=[
    ...
    # 占い系
    {
        ...
        label:
            ...
            visible:(rule)->
                return true if isAllJobsMode rule
                for job in ["Diviner","ApprenticeSeer","WolfDiviner","TinyFox","MumouDiviner"]
                    if rule.jobNumbers[job]>0
                        return true
                return false
        items:[
